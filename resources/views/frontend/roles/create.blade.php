...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Roles & Permissions <i class="nav-icon fas fa-user-lock"></i></h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('home') }}">Accueil</a></li>
                    <li class="breadcrumb-item active">Creer Role & Permissions </li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <h4>Creer Role & Permissions
                            <a href="{{ route('roles.index') }}" class="btn btn-success float-right btn-md">
                                <i class="fa fa-list"> Liste Roles & Permissions </i>
                            </a>
                        </h4>
                    </div>
                    <div class="card-body">
