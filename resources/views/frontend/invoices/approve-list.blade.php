...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Invoices No#{{ $invoice->invoice_no }}({{ date('d-M-Y',strtotime($invoice->date)) }})</h1>
            </div>
            <div class="col-sm-6">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                  ...
                  <a href="{{ route('invoices.pendind.list.index') }}" class="btn btn-info btn-sm float-right" title="Create"><i class="fa fa-list"></i> pending invoice list</a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    @php
                 ...
                 <form method="POST" action="{{ route('invoices.approve.store',$invoice->id) }}">
                    ...
                    <table border="1" width="100%" class="table-bordered">
                     ...
                     <button type="submit" class="btn btn-info mt-2">Invoice Store</button>
                 </form>
