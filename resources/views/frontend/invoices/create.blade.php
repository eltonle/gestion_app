            ...
            <div class="card-body">
              <form action="{{ route('invoices.store') }}" method="post" id="myForm">
                ...
                <div class="form-group">
                  <button type="submit" id="storeButton" class="btn btn-primary">Enregistrer la facture</button>
                </div>
              </form>
            </div>
          </div>
...
@section('scripts')
  <script id="document-template" type="text/x-handlebars-template">
   ...
   <script type="text/javascript">
      ...
      if (date=='') {
        $.notify("Date is required",{globalPosition: 'top right', type: "danger"});
        return false;
      }
      if (category_id=='') {
        $.notify("Category is required",{globalPosition: 'top right', type: "danger"});
        return false;
      }
      if (product_id=='') {
        $.notify("Product is required",{globalPosition: 'top right', type: "danger"});
        return false;
      }
